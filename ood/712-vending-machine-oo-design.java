...
// Current selection is: Coke, current inserted money: 0, current state is :
// HasSelection
// Current selection is: Sprite, current inserted money: 0, current state is :
// HasSelection
// Current selection is: Sprite, current inserted money: 500, current state is :
// InsertedMoney
// Current selection is: null, current inserted money: 0, current state is :
// NoSelection
...
class InsertedMoneyState extends AbstractState {
  ...
  public void executeTransaction() {
    ...
    if (diff >= 0) {
      System.out.println(
          "Executing transaction, will return you : " + diff + " money and item: " + vendingMachine.getSelectedItem());
      vendingMachine.setSelectedItem(null);
