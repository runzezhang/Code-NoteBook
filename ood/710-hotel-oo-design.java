...
// Printing Cache ...
// Search Request -> Start date is: Jan 1, 2013 12:00:00 AM, End date is: Oct
// 10, 2013 12:00:00 AM
// Value -> For room type: DOUBLE, available rooms are: 3; 4; . For room type:
// SINGLE, available rooms are: 1; 2; .
...
// Hotel, Room 需要大家实现,
// 在函数searchRequest和reservationRequest(makeReservation)之后我们会调用printCache来验证程序的正确性。
// *****************************
...
// Search Request -> Start date is: Jan 6, 2013 12:00:00 AM, End date is: Oct
// 10, 2013 12:00:00 AM
// Value -> For room type: DOUBLE, available rooms are: . For room type: SINGLE,
// available rooms are: 1; 2; .
